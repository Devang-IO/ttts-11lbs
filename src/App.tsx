...
const App: React.FC = () => {
  ...
  const handleLanguageDetection = useCallback((detectedLanguage: string) => {
  ...
  const generateSpeech = async () => {
    ...
    try {
      ...
      alert('Failed to generate speech. Please check your credentials and try again.');
    } finally {
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8 text-center">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Experience the power of AI-driven text-to-speech with over 200 natural voices 
            in 50+ Accents. Perfect for content creators, educators, and businesses.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6">
              <h3 className="font-semibold text-gray-800 mb-4">Usage Statistics</h3>
